...
| 个人电脑本地使用 | 桌面版安装包 | 从 [Releases](https://github.com/wyf9661/metapi/releases) 下载对应系统的桌面安装包 |
...
1. 打开 [Releases](https://github.com/wyf9661/metapi/releases) 下载与你系统匹配的桌面安装包
...
```bash
git clone https://github.com/wyf9661/metapi.git
cd metapi
npm install
npm run db:migrate
npm run dev
