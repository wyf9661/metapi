// Shared chart-building utilities. Bar-spec configuration (headroom, corner
// radius, tooltip semantics) lives here so every chart changes together.

// Money label formatter (bar labels / tooltips / legends)
...
// Horizontal bar gradients (spend / tokens / calls), taken from the logo's three
// colours.
