...
/**
 * Blocked/disabled marker (Feather "slash" geometry): used where a model is
 * disabled, so the count reads as "disabled" without a text label.
 */
export function BanIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
