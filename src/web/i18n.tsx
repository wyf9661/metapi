...
const zhToEn: Record<string, string> = {
  ...
  '把分散的 New API / One API 等站点聚合成统一网关，自动发现模型、智能路由、成本更优。': 'Turn fragmented New API / One API sites into one unified gateway with auto model discovery, smart routing, and better cost control.',
  '兼容 New API / One API / Sub2API': 'Compatible with New API / One API / Sub2API',
  ...
  // About page
  '中转站的中转站 — 将你在各处注册的 New API / One API 等 AI 中转站聚合为一个统一网关。一个 API Key、一个入口，自动发现模型、智能路由、成本最优。': 'The hub of hubs — aggregate all your New API / One API relay sites into one unified gateway. One API Key, one endpoint, with auto model discovery, smart routing, and cost optimization.',
  '核心特色': 'Key Features',
  ...
  '集中管理 New API / One API / Sub2API 等': 'Centrally manage New API / One API / Sub2API and more',
